namespace MiniblogDB.Core.Controllers
{
    ...
    using MiniblogDB.Core.Services;
    ...
    public class RobotsController : Controller
    {
        ...
        public void RsdXml()
        {
            ...
            xml.WriteElementString("enginename", "MiniblogDB.Core");
            xml.WriteElementString("enginelink", "http://github.com/Samuelp101/MiniblogDB.Core/");
        ...
        private async Task<ISyndicationFeedWriter> GetWriter(string? type, XmlWriter xmlWriter, DateTime updated)
        {
            ...
            if (type?.Equals("rss", StringComparison.OrdinalIgnoreCase) ?? false)
            {
                ...
                await rss.WriteGenerator("MiniblogDB.Core").ConfigureAwait(false);
            ...
            await atom.WriteGenerator("MiniblogDB.Core", "https://github.com/samuelp101/MiniblogDB.Core", "1.0").ConfigureAwait(false);
